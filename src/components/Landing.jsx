...
<div>
  ...
  <div className="bg-orange-200 w-full px-4 py-8">
    <div className="grid grid-cols-1 md:grid-cols-3 gap-4">
      {/* Image 1 */}
      <Link  to ="/blog/2"className="bg-white border border-gray-200 rounded-lg shadow h-[500px] w-full">
      ...
      {/* Image 3 */}
      <Link to = "blog/3" className="bg-white border border-gray-200 rounded-lg shadow h-[500px] w-full">
